...
public static void main(String []strd) throws IOException
{
 ...
 Scanner sc = new Scanner (System.in);
  ...
  do{
   ...
   System.out.println ("");
   System.out.println ("1. cari data berdasar nim");
   System.out.println ("2. cari data berdasar nama");
   System.out.println ("3. filter data mahasiswa berdasar angkatan");
   System.out.println ("4. filter berdasar nim");
   System.out.println ("5. filter berdasar nama");
   System.out.println ("6. delete data mahasiswa");
  ...
  if (piluser == 3)
     {
      System.out.print("Input code angkatan : ");
      String nim=br.readLine();

      for(int k =0;k<dataList.length;k++){
        if(dataList[k][0].toUpperCase().contains(nim.toUpperCase())){
      System.out.println();
          System.out.println(dataList[k][0]+"  "+ dataList[k][1] );
          System.out.println();
          System.out.println("Pada data ke "+k);
...
if (piluser ==5)
   ...
   if (piluser ==6)
    {
      System.out.print("Input Nim akan dihapus : ");
      String nim=br.readLine(); int index = 0;

      for(int k =0;k<dataList.length;k++)
      { 
        if(dataList[k][0].contains(nim))
        { index = k; System.out.println("data sudah dihapus ");
          bil2=1;
        }
        else{ }
      }
   ...
   if (piluser ==7)
   {  for(int k =0;k<dataList.length;k++){
       System.out.print("Input Nim akan ditambah : ");
       dataList[k][0]=br.readLine(); 
       System.out.print("Input Nama akan ditambah : ");
       dataList[k][1]=br.readLine(); 
   } 
    }
