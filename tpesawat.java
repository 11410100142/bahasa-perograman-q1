...
public class tpesawat
{
 ...
 { BufferedReader br = new BufferedReader (new InputStreamReader(System.in));
  ...
  do 
  {
   ...
   System.out.println("2. daftar kursi yang kosong");
   System.out.println("3. daftar kursi yang terisi");
   System.out.println("4. Lihat semua daftar kursi");
   System.out.println("5. View rekap kursi");
   System.out.println("6. view Total Pembayaran");
    ...
    switch(pil)
    {
     ...
     System.out.print("Jumlah Kursi Ekonomi yang Kosong : ");
      if (jmlPesanan[0]<=5)
       ...
       {
        System.out.println(0*jmlPesanan[0]);
       }
     ...
     System.out.print("Jumlah Kursi Bisnis yang Kosong : ");
      if (jmlPesanan[1]<=4)
       ...
       {
        System.out.println(0*jmlPesanan[1]);
       }
     System.out.print("Jumlah Kursi Exe yang Kosong : ");
      if (jmlPesanan[2]<=3)
       ...
       {
        System.out.println(0*jmlPesanan[2]);
       }
     System.out.print("Jumlah Kursi Vip yang Kosong : ");
      if (jmlPesanan[3]<=2)
       ...
       {
        System.out.println(0*jmlPesanan[3]);
       }
     System.out.println();
     break;
     ...
     System.out.println();
     System.out.println("================");
     System.out.println("rekap kursi");
     System.out.println("================");
     System.out.println();
     break;
